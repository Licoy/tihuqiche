...
<template>
  <article class="result-card">
    ...
    <div v-if="result.stars !== null" id="stars" class="stars" :aria-label="`${result.stars} / 3`"><FontAwesomeIcon v-for="star in 3" :key="star" :icon="faStar" :class="{ 'empty-star': star > result.stars }" aria-hidden="true" /></div>
